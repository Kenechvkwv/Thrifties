        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>The Spec Thrifties.</strong>
                    <br/>Enugu
                    <br/>Nigeria
                    <br/>07064252184
                    <br/>specthrifties@gmail.com
                    <br/><strong>Kenechukwu</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; The Spec Thrifties All Rights Reserved</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">Kenechukwu</a></p>
